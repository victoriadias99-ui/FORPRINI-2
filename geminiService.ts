...
const getSystemInstruction = () => {
  ...
  return `You are the AI Concierge for "FORPRINI", a warm, organic lifestyle tech brand. 
  ...
  If asked about products not in the list, gently steer them back to FORPRINI products.`;
};
